...
function findLargestProductInGrid(gridSize)
{
	...
	// console.log(gridArray);
	// console.log("gridArray.length: " + gridArray.length);
	
	var horizMaxProduct = 0;
	var horizTempProduct = 0;
	var horizMaxArray = [];
	var horizTempArray = [];
	
	var verMaxProduct = 0;
	var verTempProduct = 0;
	var verMaxArray = [];
	var verTempArray = [];
	
	var forwardDiagonalMaxProduct = 0;
	var forwardDiagonalTempProduct = 0;
	var forwardDiagonalMaxArray = [];
	var forwardDiagonalTempArray = [];
	
	var backwardDiagonalMaxProduct = 0;
	var backwardDiagonalTempProduct = 0;
	...
	for(var x=0; x<gridSize; x++)
	{
		for(var y=0; y<gridSize; y++)
		{
			if(x <= maxIndex && y <= maxIndex)
			{
				...
				var a = gridArray[x][y];
				var b = gridArray[x+1][y+1];
				var c = gridArray[x+2][y+2];
				var d = gridArray[x+3][y+3];
				backwardDiagonalTempArray.push(a);
				backwardDiagonalTempArray.push(b);
				backwardDiagonalTempArray.push(c);
				backwardDiagonalTempArray.push(d);
			...
			if(x <= maxIndex && y <= maxIndex)
			{
				...
				var b = gridArray[x+2][y+1];
				var c = gridArray[x+1][y+2];
				var d = gridArray[x][y+3];
				forwardDiagonalTempArray.push(a);
				forwardDiagonalTempArray.push(b);
				forwardDiagonalTempArray.push(c);
				forwardDiagonalTempArray.push(d);
			...
			if(y <= maxIndex)
			{
				...
				var a = gridArray[x][y];
				var b = gridArray[x][y+1];
				var c = gridArray[x][y+2];
				var d = gridArray[x][y+3];
				horizTempArray.push(a);
				horizTempArray.push(b);
				horizTempArray.push(c);
				horizTempArray.push(d);
			...
			if(x <= maxIndex)
			{
				...
				var c = gridArray[x+2][y];
				var d = gridArray[x+3][y];
				verTempArray.push(a);
				verTempArray.push(b);
				verTempArray.push(c);
				verTempArray.push(d);
